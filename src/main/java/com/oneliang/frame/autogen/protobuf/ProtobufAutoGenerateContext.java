	...
	public void initialize(String parameters) {
		try{
			...
			while(iterator.hasNext()){
				...
				templateParameter.setTemplateFile(projectRealPath + protobufTemplateBean.getTemplateFile());
				templateParameter.setObject(protobufTemplateBean);
				templateParameter.setToFile(projectRealPath + protobufTemplateBean.getToFolder() + Constant.Symbol.SLASH_LEFT + protobufTemplateBean.getPackageName().replace(Constant.Symbol.DOT, Constant.Symbol.SLASH_LEFT) + Constant.Symbol.SLASH_LEFT + protobufTemplateBean.getClassName() + Constant.Symbol.DOT + Constant.File.JAVA);
